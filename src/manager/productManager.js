...
class ProductManager {
    ...
    addProduct = async (newFields) => {
        ...
        const { category, title, description, code, price, stock, thumbnails } = newFields;
        ...
        const newProduct = new Product({category, title, description, code, price, stock, thumbnails});
